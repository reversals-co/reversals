            ...
            <div class="col-sm-12 col-md-12 col-lg-6">
              <div class="heading-layout2 mb-40">
                ...
                <p class="heading__desc">Change manifests in many ways: economic swings, enormous security breaches,
                  political drama, new competition, and viral social media. It’s critical not to take a “wait-and-see”
                ...
                <p class="heading__desc">for 15 years and running, it has been delivering smiles to hundreds of IT
                  ...
                  high availability.</p>
                <p class="heading__desc">Provide users with appropriate view and access permissions to requests, problems,
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="contact-panel d-flex flex-wrap mt--170">
                  <div
                    ...
                    <div class="bg-img"><img src="{{ asset('assets/website') }}/images/banners/6.jpg" alt="background"></div>
                    ...
                    <div class="d-flex flex-wrap">
                      <a href="request-quote.html" class="btn btn__secondary btn__secondary-style2 mr-30">
                        Request A Demo</a>
                      <a href="{{ route('services.index') }}" class="btn btn__white btn__bordered btn__icon">
