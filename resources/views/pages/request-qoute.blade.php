        ...
        <div class="container">
            <div class="row heading-layout2">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
                    <h3 class="heading__title mb-30">Our technology allows you to offer the <span
                            class="underlined-text">latest
                            software</span> to your possible customers!
                    </h3>
                </div><!-- /.col-xl-5 -->
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-5 offset-xl-1">
                    <div class="about__Text">
                        <p>Improve efficiency, leverage tech, and provide better customer experiences with the modern
                            technology
                            services available allover the world. Our skilled personnel, utilising the latest processing
                            software,
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
                    <div class="col-inner">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{ route('pricing') }}" class="btn btn__white btn__bordered btn__hi mr-30">Pricing &
                                Plans</a>
